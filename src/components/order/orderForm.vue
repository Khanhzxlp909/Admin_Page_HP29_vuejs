            ...
            <div class="tile mt-3">
              ...
              <table class="table table-hover table-bordered">
                ...
                <tr v-for="item in cart" :key="item.id">
                  ...
                  <td>{{ item.price }}</td>
                  <td>{{ formatPrice(item.quantity * parsePrice(item.price)) }}</
                  td>
                  <td>
          ...
          <div class="tile">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-12">
                ...
                <input class="form-control" id="voucher" ref="voucher" @input="getVoucher()" type="text"
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input class="form-control" type="number" v-model="amountReceived" @input="calculateChange">
              </div>
              <div class="form-group col-md-12">
